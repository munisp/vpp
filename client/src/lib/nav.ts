...
export const NAV_GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Outage Risk', path: '/outage-risk', keywords: ['reliability', 'blackout'] },
      { label: 'Load Breakdown', path: '/load-disaggregation', keywords: ['nilm', 'appliance'] },
      { label: 'Tariff Advisor', path: '/tariff-advisor', keywords: ['switch', 'compare'] },
      { label: 'Savings Verification', path: '/savings-verifier', keywords: ['m&v', 'baseline'] },
      { label: 'Inverter Faults', path: '/inverter-faults', keywords: ['fault', 'pv'] },
    ],
  },
  {
    id: 'market',
    ...
    items: [
      ...
      { label: 'Grid Revenue', path: '/grid-revenue', keywords: ['earnings', 'compensation'] },
      { label: 'Offset Marketplace', path: '/offset-market', keywords: ['carbon', 'trade'] },
      { label: 'Capacity Bids', path: '/capacity-bids', keywords: ['capacity market', 'bid'] },
    ],
  },
  {
    id: 'money',
    ...
    items: [
      ...
      { label: 'Budget Planner', path: '/budget-planner', keywords: ['budget', 'target'] },
    ],
  },
  {
    id: 'grid',
    ...
    items: [
      ...
      { label: 'EV Charging', path: '/ev-charging', keywords: ['vehicle', 'schedule'] },
      { label: 'Dispatch Windows', path: '/dispatch-windows', keywords: ['tou', 'charge windows'] },
      { label: 'Demand Guardian', path: '/demand-guardian', keywords: ['peak', 'demand charge'] },
      { label: 'Island Monitor', path: '/island-monitor', keywords: ['island', 'autonomy', 'resilience'] },
      { label: 'Firmware Campaigns', path: '/firmware-campaigns', adminOnly: true, keywords: ['ota', 'update', 'fleet'] },
      ...
      },
      {
        ...
        path: '/grid/protocol-conformance',
        adminOnly: true,
        keywords: [
          'ocpp',
          'openadr',
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Challenges', path: '/challenges', keywords: ['goal', 'competition'] },
      { label: 'Flex Programs', path: '/flex-loads', keywords: ['flexible load', 'enrollment'] },
      { label: 'Weekly Digest', path: '/digest-settings', keywords: ['summary', 'email', 'sms'] },
    ],
  },
  {
    id: 'tools',
    ...
    items: [
      ...
      { label: 'Portfolio', path: '/portfolio', keywords: ['sites', 'multi-site'] },
      { label: 'Work Orders', path: '/work-orders', keywords: ['maintenance', 'ticket'] },
      { label: 'Green Button Export', path: '/green-button', keywords: ['export', 'download', 'espi', 'csv'] },
