...
const EvChargingPlanner = lazy(() => import("@/pages/EvChargingPlanner"));
const OutageRisk = lazy(() => import("@/pages/OutageRisk"));
const LoadDisaggregation = lazy(() => import("@/pages/LoadDisaggregation"));
const TariffAdvisor = lazy(() => import("@/pages/TariffAdvisor"));
const DemandGuardian = lazy(() => import("@/pages/DemandGuardian"));
const WorkOrders = lazy(() => import("@/pages/WorkOrders"));
const FirmwareCampaigns = lazy(() => import("@/pages/FirmwareCampaigns"));
const SavingsVerifier = lazy(() => import("@/pages/SavingsVerifier"));
const FlexLoads = lazy(() => import("@/pages/FlexLoads"));
const Portfolio = lazy(() => import("@/pages/Portfolio"));
const GridRevenue = lazy(() => import("@/pages/GridRevenue"));
const OffsetMarket = lazy(() => import("@/pages/OffsetMarket"));
const InverterFaults = lazy(() => import("@/pages/InverterFaults"));
const Challenges = lazy(() => import("@/pages/Challenges"));
const DigestSettings = lazy(() => import("@/pages/DigestSettings"));
const GreenButton = lazy(() => import("@/pages/GreenButton"));
const CapacityBids = lazy(() => import("@/pages/CapacityBids"));
const IslandMonitor = lazy(() => import("@/pages/IslandMonitor"));
const DispatchWindows = lazy(() => import("@/pages/DispatchWindows"));
